...
function SinglePageSelector({ page }: SinglePageSelectorPropsType) {
  return (
    <div className="relative flex items-center justify-between py-2 pl-[15px] pr-[22px] w-full">
      <label
        htmlFor={page}
        className="cursor-pointer text-sm font-normal text-charcoalblack"
      >
        {page}
      </label>
      <input
        ...
        name={page}
        id={page}
        className="appearance-none flex items-center justify-center cursor-pointer border border-divider
        ...
        checked:bg-blue checked:hover:bg-lightblue"
      />
      <svg
        className="absolute top-[11px] right-[25px] w-[16.88px] h-[10.1px] pointer-events-none fill-none mt-1"
        width="17"
        height="13"
        viewBox="0 0 17 13"
        fill="none"
